                    ...
                    <table class="w-full text-sm text-left text-gray-700">
                        <thead class="bg-gray-50 border-b border-gray-200">
                            <tr>
                                ...
                                <th class="px-6 py-3 font-medium text-gray-500 uppercase tracking-wide text-xs">Kode</th>
                        ...
                        <tbody class="divide-y divide-gray-100">
                            ...
                            ?>
                                <tr class="hover:bg-gray-50 transition">
                                    ...
                                    <td class="px-6 py-4 text-gray-800"><?= htmlspecialchars($d['kode'] ?? ''); ?></td>
                                    <td class="px-6 py-4 text-gray-800 font-medium"><?= htmlspecialchars($d['nama_jurusan'] ?? ''); ?></td>
