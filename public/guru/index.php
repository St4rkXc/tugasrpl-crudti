...
<body class="bg-gray-50 min-h-screen">
    <div class="flex gap-x-6 h-full">
        ...
        <div class="w-full p-4">
            <header class="mb-6">
                <h1 class="text-2xl sm:text-3xl font-semibold text-gray-800">Data Guru</h1>
            </header>
                    ...
                    <table class="w-full text-sm text-left text-gray-700">
                        <thead class="bg-gray-50 border-b border-gray-200">
                            <tr>
                                ...
                                <th class="px-6 py-3 font-medium text-gray-500 uppercase tracking-wide text-xs">NIP</th>
                                <th class="px-6 py-3 font-medium text-gray-500 uppercase tracking-wide text-xs">Nama</th>
                                <th class="px-6 py-3 font-medium text-gray-500 uppercase tracking-wide text-xs">Mapel</th>
                        ...
                        <tbody class="divide-y divide-gray-100">
                            ...
                            ?>
                                <tr class="hover:bg-gray-50 transition">
                                    ...
                                    <td class="px-6 py-4 text-gray-800"><?= htmlspecialchars($d['nip'] ?? ''); ?></td>
                                    <td class="px-6 py-4 text-gray-800 font-medium"><?= htmlspecialchars($d['nama'] ?? ''); ?></td>
                                    <td class="px-6 py-4 text-gray-700"><?= htmlspecialchars($d['mapel'] ?? ''); ?></td>
