                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        ?>
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-700"><?= htmlspecialchars($d['nis'] ?? ''); ?></td>
                                <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-700"><?= htmlspecialchars($d['nama'] ?? ''); ?></td>
                                <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-700"><?= htmlspecialchars($d['kelas'] ?? ''); ?></td>
                                <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-700"><?= htmlspecialchars($d['jurusan'] ?? ''); ?></td>
